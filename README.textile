...
@wget http://github.com/doke/oh-my-zsh/raw/master/tools/install.sh -O - | sh@

or with curl:

@curl http://github.com/doke/oh-my-zsh/raw/master/tools/install.sh | sh@
...
1. Clone the repository
  ...
  @git clone git://github.com/doke/oh-my-zsh.git ~/.oh-my-zsh@
